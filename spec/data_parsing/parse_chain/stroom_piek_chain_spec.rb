...
describe P1MeterReader::DataParsing::ParseChain::StroomPiekChain do
  describe :can_handle? do
    subject { P1MeterReader::DataParsing::ParseChain::StroomPiekChain.new.can_handle?(line) }
  ...
  describe :handle do
    let(:subject) { P1MeterReader::DataParsing::ParseChain::StroomPiekChain.new }
